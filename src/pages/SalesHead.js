...
import { GetHeadLevel } from "../Services/GetHeadLevel";





const SalesHead = ({ selectedProduct, levelSimulation }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const summaeyData = await GetHeadLevel(sessionStorage.getItem("name"), levelSimulation.name, selectedProduct.name)
  ...
  return (
    <>
      <div className="grid">
        ...
        <h1 className="col-md-12 text-center text-color-secondary ml-4">Sales Head Level Simulation</h1>
